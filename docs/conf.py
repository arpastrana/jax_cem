...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith("jax_cem"):
        return None
    ...
    return f"https://github.com//jax_cem/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    "package_name": "jax_cem",
    "package_title": project,
    "package_version": release,
    "package_author": "Rafael Pastrana",
    "package_docs": "https://.github.io/jax_cem/",
    "package_repo": "https://github.com//jax_cem",
    "package_old_versions_txt": "https://.github.io/jax_cem/doc_versions.txt",
}
